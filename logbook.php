    ...
    <table class="layout" align="center" class="layout">
        ...
        <tr class="content">
            <td class="cont" colspan="3">
                <h2>ENROLLMENT FYP</h2>
                <br>
                <form name="formBar" align="center">
                    <table align="center" class="table-enroll">
                        <tr>
                            <th class="table1"><h3>FINAL-YEAR PROJECT</h3></th>
                        </tr>
                        <tr>
                            <td class="table1">
                                <input type="button" value="Enroll FYP 1">
                                <input type="button" value="Enroll FYP 2">
                            </td>
                        </tr>
                        <tr></tr>
                        <tr></tr>
