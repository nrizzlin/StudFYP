                                ...
                                <form class="form-inline" method="POST"  enctype="multipart/form-data">
                                    <table align="center" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="day" class="form-control"  required="required"/></td>
                                        </tr>

                                        <tr>
                                            <td><label class="control-label">Activities: </label></td>
                                            <td><textarea name="txt_activities" cols="50" rows="10" class="form-control" required="required"></textarea></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="txt_note" class="form-control" required="required" /></td>
                                        </tr>
