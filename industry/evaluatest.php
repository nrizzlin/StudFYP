...
if(isset($_SESSION['User'])){
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	if($existing_rec){
		$rs_logbook = $connection->prepare("update rubric set weekly_evaluation='".$marks."' where logbook_id='".$logbook_id."'");
		$rs_logbook->execute();
	}else{
		$ins_logbook = "insert into rubric(`logbook_id`,`log_feedback`,`weekly_evaluation`) 
						values('".$logbook_id."','NA','".$marks."')";					
  ...
  $id = $_GET['id'];
  $fypst = $_GET['sID'];
	 $sql2 = "select user.user_username,fyp_project.project_ID,logbook.logbook_id,fyp_project.rating_id,fyp_project.lecturer_ID
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-12"><h4 class="page-head-line">Student Eualation </h4></div>
                </div> 
                ...
                <table class="table">
                	...
                	<tr>
                        ...
                        <td><input type="text" name="marks" id="marks" class="form-control"/></td>
                    </tr>
                </table>
